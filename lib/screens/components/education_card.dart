...
class EducationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label:
          'Education: ${data['course']} at ${data['college']}, Batch: ${data['batch']}',
      child: Neumorphic(
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(data['course'], style: AppText.b2b),
                  Text(data['batch'], style: AppText.b3!.cl(Colors.white60)),
                  Text(data['college'], style: AppText.b3!.w(6)),
                ],
              ),
            ),
            CircleBG(
